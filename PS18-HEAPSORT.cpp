/*AIM: Read the marks obtained by students of second year in an online examination of 
particular subject. Find out maximum and minimum marks obtained in that subject. Use heap 
data structure. Analyze the algorithm.insert all no of marks first then see output 
PROGRAM: */
#include<iostream> 
using namespace std; 
...
{ 
   ...
   void getdata(); 
   void insert1(int heap[],int i); 
   void upadjust1(int heap[],int i); 
   void insert2(int heap1[],int i); 
